...
export default class PermissionController {
    ...
    public async getById(req: Request, res: Response): Promise<any> {
        try {
            ...
            const result: any = await NotificationTemplate.findOne({ id: id }).lean();
            // console.log(result);
    ...
    public async delete(req: Request, res: Response): Promise<any> {
        try {
            ...
            const id = parseInt(req.params.id);
            const result = await NotificationTemplate.deleteOne({ id: id });
    ...
    public async status(req: Request, res: Response): Promise<any> {
        try {
            ...
            const updationstatus = await NotificationTemplate.findOneAndUpdate({ id: id }, { status: status }).lean();
            const updatedData: any = await NotificationTemplate.find({ id: id }).lean();
            if (updationstatus) {
