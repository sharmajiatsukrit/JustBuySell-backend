...
const productRequestSchema: Schema = new Schema({
    ...
    selling_unit_id: { type: Object, default: {} },
    selling_unit: { type: String, default: '' },
    individual_pack_size_id: { type: Object, default: {} },
    individual_pack_size: { type: String, default: '' },
    individual_pack_unit_id: { type: Object, default: {} },
    individual_pack_unit: { type: String, default: 0 },
    Individual_packing_type_id: { type: Object, default: {} },
    Individual_packing_type: { type: String, default: 0 },
    master_pack_qty: { type: String, default: 0 },
    product_image: { type: String, default: '' },
    master_pack_type_id: { type: Object, default: {} },
    master_pack_type: { type: String, default: 0 },
    conversion_unit_id: { type: Object, default: {} },
    conversion_unit: { type: String, default: 0 },
    conversion_unit_rate: { type: String, default: 0 },
