...
routes.post("/add", validateRequest, authAdmin, userController.add.bind(userController));
routes.put("/update/:id", validateRequest, authAdmin, userController.update.bind(userController));
